...
# question posted at https://stackoverflow.com/questions/59632120/converting-tensor-to-ragged-tensor-in-graph-mode-using-keras
...
sequence_in = tf.keras.layers.Input(shape=(4,), name='input_1', dtype=tf.int32, ragged=False)


ragged_in = tf.RaggedTensor.from_row_lengths(sequence_in[0], [2, 2], validate=False)
embedded_ragged = tf.keras.layers.Embedding(9, 4)(ragged_in)

embedded_tensor = tf.keras.layers.Embedding(9, 4)(sequence_in[0])
